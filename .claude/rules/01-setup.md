...
1. [Understanding Polylith Core Concepts](#1-understanding-polylith-core-concepts)
2. [Monorepo Structure and Organization](#2-monorepo-structure-and-organization)
3. [Code Sharing and Reusability](#3-code-sharing-and-reusability)
4. [Testing Strategy](#4-testing-strategy)
5. [Tool Versions](#5-tool-versions)
...
- [ ] Set up directory structure: `bases/`, `components/`, `development/`, `projects/`, `test/`
